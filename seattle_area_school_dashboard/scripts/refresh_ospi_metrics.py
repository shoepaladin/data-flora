...
from seattle_schools_dashboard.nces import METRIC_DEFINITIONS, utc_timestamp  # noqa: E402
...
payload.setdefault("source_pulled_at", {})["ospi_new_metrics"] = utc_timestamp()
